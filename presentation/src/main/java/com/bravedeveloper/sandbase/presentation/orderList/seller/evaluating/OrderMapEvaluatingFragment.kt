...
import com.bravedeveloper.sandbase.databinding.ItemOrderSellerEvaluatingMapBinding
...
@AndroidEntryPoint
class OrderMapEvaluatingFragment: BaseOrderMapFragment<ItemOrderSellerEvaluatingMapBinding>(ItemOrderSellerEvaluatingMapBinding::inflate) {
